    ...
    <div>
        <div class="container py-2">
            ...
            <div class="d-flex justify-content-center align-items-center flex-column pt-4">
                ...
                <div>
                    <p style="font-family:'Ubuntu',sans-serif">You do have account ?<a href="{{ route("register") }}" class="text-decoration-none mx-3 " style="font-size:20px">Log In</a></p>
                </div>
                ...
                <div class="w-100 ">
                    <form >
                        <input type="email" class="form-control my-3" class="email" placeholder="E-mail" name="email">
                        <input type="email" class="form-control my-3" class="email" placeholder="Confirm Your E-mail" name="email">
                        <input type="number" class="form-control my-3" class="phone" placeholder="Phone" name="phone">
                        <input type="password" class="form-control my-3" class="password" placeholder="Password" name="password">
                        <input type="password" class="form-control my-3" class="password" placeholder="Confirm Your Password" name="password">
