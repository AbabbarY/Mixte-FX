    ...
    <div>
        <div class="container py-2">
            ...
            <div class="d-flex justify-content-center align-items-center flex-column pt-4">
                ...
                <div>
                    <p style="font-family:'Ubuntu',sans-serif">You do not have an account ?<a href="{{ __('register') }}" class="text-decoration-none mx-3 " style="font-size:20px">Register</a></p>
                </div>
                ...
                @endif
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <input type="email" class="form-control" class="email" placeholder="E-mail" name="email" :value="old('email')"">
                        
                        <input type="password" class="form-control my-3" class="password" placeholder="Password" name="password" required autocomplete="current-password">
                        <div>
                       ...
                       <div class="check my-3 d-flex justify-content-between align-items-center">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="flexCheckChecked" class="check">{{ __('Remember me') }}</label>
                            </div>
                            <div >
                        ...
                        <input type="submit" name="submit" value="{{ __('Log in') }}" class="submit">
